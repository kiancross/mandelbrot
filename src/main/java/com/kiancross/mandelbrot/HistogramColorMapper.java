...
public class HistogramColorMapper {
  ...
  */
   ...
   *
   * @param maximumIterations The maximum number of iterations that will appear in the list of iterations.
  ...
  */
  ...
  /**
   * Takes an array of iteration values and returns an array where each position corresponds to
   * an iteration value, and the value at this position is the number of times the iteration value
   * occurred.
   *
