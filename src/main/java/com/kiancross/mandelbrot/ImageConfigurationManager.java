...
/**
 * Used to manage image configurations - allows new configurations to be added
 * and stores the history so that actions can be undone/redone.
*/
public class ImageConfigurationManager {
  ...
  */
  ...
  /**
   * Property used to store the current configuration - this allows other parts of the code
   * to observe this property and execute code when it changes.
  */
  final private InformInitialObjectProperty<ImageConfiguration> currentConfigurationProperty =
  ...
  */
  ...
  /**
   * Add a new configuration. If the configuration has not changed it will not be
   * added to the undo stack.
   *
   * @param newConfiguration The new configuration to add.
   *
   * @return Boolean value indicating if the configuration was added to the undo
   * stack.
  */
