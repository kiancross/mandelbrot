...
/**
 * Class to represent the configuration used to display an image of the mandelbrot set. An instance
 * of the class can't be made directly - the builder must be used.
 */
public class ImageConfiguration implements Serializable {
   ...
   */
  private final boolean overlayZoom;

  /**
   * Colour theme to be used to display the image.
   */
  private final ColorGradient colorTheme;
  ...
  public static class Builder {
     ...
     *
     * @param maximumIterations Maximum number of iterations before assuming the value of C lies
     *        within the set.
     *
     * @return This builder.
     */
    ...
    public ImageConfiguration build() {
      return new ImageConfiguration(bound, escapeRadius, maximumIterations, overlayZoom,
          colorTheme);
    }
  }
   ...
   * @param colorTheme Colour theme to be used to display the image.
   */
  private ImageConfiguration(final Bound bound, final double escapeRadius,
      final int maximumIterations, final boolean overlayZoom, final ColorGradient colorTheme) {
   ...
   * 
   * @return The escape radius used when calculating the iteration values.
   */
   ...
   *
   * @return The maximum number of iterations done before assuming the value of C lies within the
   *         set.
   */
  ...
  public boolean equals(final Object b) {
    ...
    return bound.equals(configuration.getBound()) && escapeRadius == configuration.getEscapeRadius()
