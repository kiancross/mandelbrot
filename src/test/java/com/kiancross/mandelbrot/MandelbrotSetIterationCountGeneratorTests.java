...
/**
 * Tests for the generation of the mandelbrot iteration values. These unit tests are not too
 * extensive, as the proof of it working is fairly clear in the image result. It is a simple sanity
 * test to ensure that the values at least appear to be correct and that edge cases are dealt with
 * correctly.
 */
public class MandelbrotSetIterationCountGeneratorTests {
  ...
  public void testNullBound() {
    assertThrows(IllegalArgumentException.class, () -> {
      final MandelbrotSetIterationCountGenerator generator =
          new MandelbrotSetIterationCountGenerator(null, 1000, 2);
    });
  }

  /**
   * Test that attempting to calculate values with 0 threads throws an exception.
   */
  @Test
